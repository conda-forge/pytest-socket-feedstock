...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-socket-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6097&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-socket-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-socket` can be installed with:

```
conda install pytest-socket
```

It is possible to list all of the versions of `pytest-socket` available on your platform with:
